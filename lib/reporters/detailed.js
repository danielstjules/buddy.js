...
DetailedReporter.prototype._print = function(magicNumber) {
  ...
  var lines = magicNumber.contextLines;
  ...
  var start = magicNumber.lineSource.slice(minCount, magicNumber.startColumn);
  var end = magicNumber.lineSource.slice(magicNumber.endColumn).trimRight();
